...
const Footer = () => {
  ...
  return (
    <footer className="mt-16 rounded-2xl bg-dark m-10 flex flex-col items-center text-light">
      <h3 className="mt-16 font-medium text-center capitalize text-3xl px-4">
      ...
      <form
        ...
        className="mt-6 min-w-[384px] flex items-stretch bg-light p-2 rounded mx-0"
      >
        <input
          type="text"
      ...
      <div className="w-full mt-20 relative font-medium border-t border-solid border-light py-6 px-8 flex flex-row items-center justify-between">
        ...
        <div className="text-center underline">
          Made with &hearts; by{" "}
          <a href="https://devdreaming.com">CodeBucks</a>
        </div>
      </div>
    </footer>
  );
