...
const Footer = () => {
  ...
  console.log(errors);
  return (
    <footer className="mt-24 rounded-2xl bg-dark m-10 flex flex-col items-center text-light">
      <h3 className="mt-10 font-medium text-center capitalize text-3xl px-4">
        Interesting Stories | Updates | Guides
      </h3>
      <p className="mt-5 px-4 text-center w-3/5 font-light text-base">
        Subscribe to learn about new technology and updates. <br />
        Join over 5000+ members community to stay up to date with latest news.
      </p>
      <form
        onSubmit={handleSubmit(onSubmit)}
        className="mt-6 min-w-[384px] flex items-stretch bg-light p-2 rounded mx-04"
      >
        <input
          type="text"
      ...
      <div className="w-full mt-5 relative font-medium border-t border-solid border-light py-6 px-8 flex flex-row items-center justify-between">
        ...
        <div className="text-center">
          Made with &hearts; by{" "}
          <a href="https://devdreaming.com" className="underline">CodeBucks</a>
        </div>
      </div>
    </footer>
  );
